...
class Agent():
    ...
    def init_bins(self, lower_bound, upper_bound, num_bins):
        ...
        # use the linspace to slice the interval with given lower bound, upper bound and number of bins. 
        # return the list from index 1.
    ...
    def discretize_value(self, value, bins):
        ...
        # Discretize the value with given bins. 
        # Using np.digitize() to determine the value in which interval of bins.
