...
class Agent():
    ...
    def choose_action(self, state):
        ...
        # use random number from 0 to 1
        # if the number is bigger than the epsilon, then return the maximum Q in the Q table.
        # if the number is smaller than the epsilon, then return the random action.
    ...
    def learn(self, state, action, reward, next_state, done):
        ...
        # calculate the new q-value with the function of the Q learning
