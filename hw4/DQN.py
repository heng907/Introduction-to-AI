...
class Agent():
    ...
    def learn(self):
        ...
        # Use function "sample" defined in class "replay_buffer" to get the sampled data.
        ...
        # use nn.MSELoss() func. to evaluate the loss of q_eval and q_target
        loss_func = nn.MSELoss()
        loss = loss_func(q_eval, q_target)

        # zerp-out the gradients before doing backpropagation.
    ...
    def check_max_Q(self):
        ...
        # change the initial state to tensor, forward to the NN.
        x = torch.unsqueeze(torch.tensor(self.env.reset(), dtype=torch.float), 0)
        # find out the max Q and return it.
